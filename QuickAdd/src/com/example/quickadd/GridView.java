...
public class GridView extends View {
	...
	public View constructTable() {
		final TableLayout tableLayout = (TableLayout) LayoutInflater
				.from(mContext).inflate(R.layout.grid, null)
				.findViewById(R.id.grid_table);
